      ...
      <div class="container px-6 py-10 mx-auto">
        <div class="lg:flex lg:-mx-6">
          ...
          <div class="mt-8 lg:w-1/4 lg:mt-0 lg:px-6">
            <div>
              <h3 class="text-primary font-bold capitalize">
                Design instument
              </h3>
            ...
            <div>
              <h3 class="text-primary font-bold capitalize">UI Resource</h3>
            ...
            <div>
              <h3 class="text-primary font-bold capitalize">Premium kits</h3>
